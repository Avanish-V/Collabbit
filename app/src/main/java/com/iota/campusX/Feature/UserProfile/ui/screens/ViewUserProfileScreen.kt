...
fun ViewProfile(
    ...
    connectionRequestViewModel: ConnectionRequestViewModel= koinViewModel(),
) {
    ...
    val connectionState by connectionRequestViewModel.connectionState.collectAsState()
    ...
    LaunchedEffect(useridByFeed) {
        useridByFeed?.let { connectionRequestViewModel.hasConnection(it) }
    }
                                    ...
                                    scope.launch {
                                        viewProfileData?.let {
                                            when(connectionState){
                                                is UiState.Loading -> {}
                                                is UiState.Success -> {
                                                    val result = (connectionState as UiState.Success).data
                                ...
                                onMessageClick ={
                                    navHostController.navigate(Routes.Main.SendMessage.routes).apply {
                                        navHostController.currentBackStackEntry?.savedStateHandle?.apply {
                                            set("USER_ID", viewProfileData?.uid)
                                            set("USER_NAME", viewProfileData?.name)
                                            set("USER_IMAGE", viewProfileData?.image)
                                        }
                                    }
                                },
                                        ...
                                        1 ->{
                                            ...
                                            useridByFeed?.let { userId ->
                                                PostScreenComponent(
                                                    ...
                                                    onPageActive = {
                                                        viewUserPostViewModel.fetchViewUserPosts(
                                                            userId = userId,
                                                        )
                                                    },
                                                    onRetryClick = {},
            ...
            Column() {
                ProfileComponent(
                    ...
                    body = {
                        ...
                        if (userBasicProfileDTO.about.isNotEmpty()) {
                            // Show Bio Text
                            Text(
                                text = userBasicProfileDTO.about,
                ...
                ProfileComponent(
                    ...
                    body = {
                        ...
                        if (userBasicProfileDTO.interests.isNullOrEmpty()) {
