...
fun AppUserProfile(
   ...
   val  profileViewModel: UserProfileViewModel = koinInject()
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = "Profile", style = MaterialTheme.typography.headlineSmall) },
                actions = {
                    IconButton(
                            ...
                            when (it) {
                                ...
                                2 -> {
                                    ...
                                    RepliesComponent(
                                        ...
                                        navHostController = navHostController,
                                        onRetryClick = {
                                            appUserReplyViewModel.getUserReplies(profile?.uid ?: "")
                                        },
                                        onPageActive = {
                                            appUserReplyViewModel.getUserReplies(profile?.uid ?: "")
                                        }
        ...
        item {
            Column() {
                ProfileComponent(
                    ...
                    editIconVisible = userBasicProfileDTO.about.isNotEmpty()
                )
                ...
                ProfileComponent(
                    ...
                    editIconVisible = userBasicProfileDTO.interests.isNullOrEmpty()
                )
                    ...
                    onDotMenuClick = {
                        postMenuState.open(
                            FeedContent(
                                ...
                                text = item.postContent.postText.toString(),
...
fun UserReplyItem(
    ...
    Column (
        ...
        Row {
            ...
            Avatar(
                imageUrl = userReplyDTO.post.creatorDetail.profile?.image ?: "",
            ...
            Column {
                ...
                userReplyDTO.post.createdAt?.let {
                    FeedHeader(
                        creator = userReplyDTO.post.creatorDetail,
                        postedAt = getTimeAgo(it),
                        visibilityMode = userReplyDTO.post.visibilityMode,
